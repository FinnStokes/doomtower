...
Event.register_event_type('update_room')
...
Event.register_event_type('update_elevator')
...
# Render should react by adding the relevant graphic.
Event.register_event_type('new_entity')

# remove_entity(id)
# This event should be produced when an entity is removed.
# Render should react by deleting the relevant graphic.
Event.register_event_type('remove_entity')
...
Event.register_event_type('update_entity')
